...
public class Activity9 {
    ...
    @Test
    public void testSelectLeadsOption() throws InterruptedException {
        ...
        WebElement viewLeads = wait.until(
                ExpectedConditions.elementToBeClickable(
                        By.xpath("//span[normalize-space()='View Leads']")));

        viewLeads.click();    
    }
    
    @Test(dependsOnMethods="testSelectLeadsOption")
    public void testLeadsPage() throws InterruptedException {

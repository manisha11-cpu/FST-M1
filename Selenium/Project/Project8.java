...
public class Activity8 {
    ...
    @Test
    public void testSelectAccountsOption() throws InterruptedException {
        ...
        WebElement Accounts = wait.until(
                ExpectedConditions.visibilityOfElementLocated(
                        By.xpath("//span[normalize-space()='Accounts']")));

        action.moveToElement(Accounts).perform();

        WebElement viewAccounts = wait.until(
                ExpectedConditions.elementToBeClickable(
                        By.xpath("//span[normalize-space()='View Accounts']")));

        viewAccounts.click();    
    }
    
    @Test(dependsOnMethods="testSelectAccountsOption")
    public void testAccountsPage() throws InterruptedException {
